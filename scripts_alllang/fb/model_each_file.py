...
cleaned_posts = get_clean_text(fb_posts)
...
tokenized = remove_1_letter(tokenized_posts)

lemmatized_posts = lemmatize_posts(tokenized)


# For some reason we again have words with special letters 
lemmatized_posts = change(lemmatized_posts)
...
no_stops = remove_stops(lemmatized_posts, my_stop_words)
...
posts_bigrams = [bigram[line] for line in no_1_letter]
